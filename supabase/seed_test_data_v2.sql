...
-- 1. 建立測試食物
-- ============================================================
INSERT INTO diet_daily_foods (id, name, created_at)
VALUES
  ('aaaa1111-2222-3333-4444-555555555501', 'SEED_白飯', NOW()),
  ('aaaa1111-2222-3333-4444-555555555502', 'SEED_雞胸肉', NOW()),
  ('aaaa1111-2222-3333-4444-555555555503', 'SEED_青花菜', NOW()),
  ('aaaa1111-2222-3333-4444-555555555504', 'SEED_香蕉', NOW())
...
-- ============================================================
-- 測試用戶: e7c62e70-7e95-40e3-84c6-f27c84ede44e
...
VALUES
  ...
  ('e7c62e70-7e95-40e3-84c6-f27c84ede44e', 'aaaa1111-2222-3333-4444-555555555501', 'SEED_白飯', '2024-11-07 07:30:00+00', NOW()),
  ('e7c62e70-7e95-40e3-84c6-f27c84ede44e', 'aaaa1111-2222-3333-4444-555555555502', 'SEED_雞胸肉', '2024-11-07 07:30:00+00', NOW()),

  -- 2024-11-07 午餐：白飯 + 青花菜
  ('e7c62e70-7e95-40e3-84c6-f27c84ede44e', 'aaaa1111-2222-3333-4444-555555555501', 'SEED_白飯', '2024-11-07 12:00:00+00', NOW()),
  ('e7c62e70-7e95-40e3-84c6-f27c84ede44e', 'aaaa1111-2222-3333-4444-555555555503', 'SEED_青花菜', '2024-11-07 12:00:00+00', NOW()),

  -- 2024-11-08 早餐：香蕉 (missing cache test)
  ('e7c62e70-7e95-40e3-84c6-f27c84ede44e', 'aaaa1111-2222-3333-4444-555555555504', 'SEED_香蕉', '2024-11-08 08:00:00+00', NOW()),

  -- 2024-11-09 午餐：白飯 + 雞胸肉 + 青花菜
  ('e7c62e70-7e95-40e3-84c6-f27c84ede44e', 'aaaa1111-2222-3333-4444-555555555501', 'SEED_白飯', '2024-11-09 12:30:00+00', NOW()),
  ('e7c62e70-7e95-40e3-84c6-f27c84ede44e', 'aaaa1111-2222-3333-4444-555555555502', 'SEED_雞胸肉', '2024-11-09 12:30:00+00', NOW()),
  ('e7c62e70-7e95-40e3-84c6-f27c84ede44e', 'aaaa1111-2222-3333-4444-555555555503', 'SEED_青花菜', '2024-11-09 12:30:00+00', NOW()),

  -- 2024-11-10 晚餐：雞胸肉
  ('e7c62e70-7e95-40e3-84c6-f27c84ede44e', 'aaaa1111-2222-3333-4444-555555555502', 'SEED_雞胸肉', '2024-11-10 18:00:00+00', NOW());
